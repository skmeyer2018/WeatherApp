...
def get_weather():
	...
	#print(mssg)
        ...
        print(len(future_cast))
        print(future_cast[3]["Description"].lower())
                       ...
                       try:
                         ...
                         for evt in weather_events:
                          ...
                          if evt in desc:
                           print(f"{evt}.jpg")
                          if evt == "sun":
                           weather_pic2["image"]=sunpic
                           break
                          elif evt == "cloud":
                           weather_pic2["image"]=cloudpic
                           break
                          elif evt == "rain" or evt == "shower":
                           weather_pic2["image"]=rainpic
                           break
                          elif evt == "wind":
                           weather_pic2["image"]=windpic
                           break
                          elif evt == "snow":
                           weather_pic2["image"]=snowpic
                           break
                          else:
                           break
                       except:
                       ...
                       try:
                         ...
                         for evt in weather_events:
                          ...
                          if evt in desc:
                           print(f"{evt}.jpg")
                          if evt == "sun":
                           weather_pic3["image"]=sunpic
                           break
                          elif evt == "cloud":
                           weather_pic3["image"]=cloudpic
                           break
                          elif evt == "rain" or evt == "shower":
                           weather_pic3["image"]=rainpic
                           break
                          elif evt == "wind":
                           weather_pic3["image"]=windpic
                           break
                          elif evt == "snow":
                           weather_pic3["image"]=snowpic
                           break
                          else:
                           break
                       except:
                       ...
                       try:
                         ...
                         for evt in weather_events:
                          ...
                          if evt in desc:
                           print(f"{evt}.jpg")
                          if evt == "sun":
                           weather_pic4["image"]=sunpic
                           break
                          elif evt == "cloud":
                           weather_pic4["image"]=cloudpic
                           break
                          elif evt == "rain" or evt == "shower":
                           weather_pic4["image"]=rainpic
                           break
                          elif evt == "wind":
                           weather_pic4["image"]=windpic
                           break
                          elif evt == "snow":
                           weather_pic4["image"]=snowpic
                           break
                          else:
                           break
                       except:
...
weather_pic2.place(x=230,y=510)
weather_pic2.config(bg="#ccddee")
weather_pic3.place(x=380,y=510)
weather_pic3.config(bg="#ccddee")
weather_pic4.place(x=530,y=510)
weather_pic4.config(bg="#ccddee")
...
weather_day1_label=Label(master, font=("Arial",10,"bold"))
weather_day2_label=Label(master, font=("Arial",10,"bold"))
weather_day3_label=Label(master, font=("Arial",10,"bold"))
weather_day4_label=Label(master, font=("Arial",10,"bold"))
